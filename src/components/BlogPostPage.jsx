...
const BlogPostPage = () => {
  ...
  //   // Fetch the final URL from the API
  //   fetch(`http://localhost:3001/url/${shortid}`)
  //     .then((response) => {
  //       if (!response.ok) {
  ...
  //     })
  //     .then((data) => {
  //       // Use data.redirectURL to redirect to the final URL after a delay
  //       setTimeout(() => {
  ...
  //    fetch(`http://localhost:3001/second-url/${shortid}`)
  //     .then((response) => {
  //       if (!response.ok) {
  //         throw new Error("Network response was not ok");
  //       }
  ...
  //     })
  //     .then((redirectURL) => {
  //       // Redirect to the final destination URL after a delay
  //       setTimeout(() => {
  ...
  //   // Fetch the final destination URL from the new endpoint
  //   fetch(`http://localhost:3001/final-url/${shortid}`)
  //     .then((response) => {
  //       if (!response.ok) {
  //         throw new Error("Network response was not ok");
  //       }
